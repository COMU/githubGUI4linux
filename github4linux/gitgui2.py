...
class Ui_MainWindow(QtGui.QMainWindow):
    def __init__(self):
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(50,280,70, 24))
...
#        QtCore.QObject.connect(self.pushButton_4, QtCore.SIGNAL(_fromUtf8("clicked()")), self.clone_repo)
    def organizations_list(self):
        ...
        context = json.loads(context)
        for organization in context:
            liste.addItem(organization['repos_url'])
